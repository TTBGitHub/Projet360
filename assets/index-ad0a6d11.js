...
`)+`
`+d);const A=E+m+o,w=E+d+a,I=Xu(r,r.VERTEX_SHADER,A),R=Xu(r,r.FRAGMENT_SHADER,w);r.attachShader(v,I),r.attachShader(v,R),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function C(O){if(n.debug.checkShaderErrors){const K=r.getProgramInfoLog(v)||"",W=r.getShaderInfoLog(I)||"",z=r.getShaderInfoLog(R)||"",oe=K.trim(),H=W.trim(),se=z.trim();let X=!0,fe=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(X=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,I,R);else{const me=$u(r,I,"vertex"),Ce=$u(r,R,"fragment");Et("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`;function Tb(n,e,t){let i=new Id;const r=new at,s=new at,o=new Tt,a=new Wx({depthPacking:V0}),l=new Xx,c={},u=t.maxTextureSize,f={[Ci]:kt,[kt]:Ci,[Yn]:Yn},h=new ai({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new at},radius:{value:4}},vertexShader:yb,fragmentShader:Eb}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const g=new ci;g.setAttribute("position",new Un(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new En(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=dd;let d=this.type;this.render=function(R,C,k){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const y=n.getRenderTarget(),S=n.getActiveCubeFace(),O=n.getActiveMipmapLevel(),K=n.state;K.setBlending(ei),K.buffers.depth.getReversed()===!0?K.buffers.color.setClear(0,0,0,0):K.buffers.color.setClear(1,1,1,1),K.buffers.depth.setTest(!0),K.setScissorTest(!1);const W=d!==Xn&&this.type===Xn,z=d===Xn&&this.type!==Xn;for(let oe=0,H=R.length;oe<H;oe++){const se=R[oe],X=se.shadow;if(X===void 0){qe("WebGLShadowMap:",se,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const fe=X.getFrameExtents();if(r.multiply(fe),s.copy(X.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/fe.x),r.x=s.x*fe.x,X.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/fe.y),r.y=s.y*fe.y,X.mapSize.y=s.y)),X.map===null||W===!0||z===!0){const Ce=this.type!==Xn?{minFilter:on,magFilter:on}:{};X.map!==null&&X.map.dispose(),X.map=new Zi(r.x,r.y,Ce),X.map.texture.name=se.name+".shadowMap",X.camera.updateProjectionMatrix()}n.setRenderTarget(X.map),n.clear();const me=X.getViewportCount();for(let Ce=0;Ce<me;Ce++){const ke=X.getViewport(Ce);o.set(s.x*ke.x,s.y*ke.y,s.x*ke.z,s.y*ke.w),K.viewport(o),X.updateMatrices(se,Ce),i=X.getFrustum(),w(C,k,X.camera,se,this.type)}X.isPointLightShadow!==!0&&this.type===Xn&&E(X,k),X.needsUpdate=!1}d=this.type,m.needsUpdate=!1,n.setRenderTarget(y,S,O)};function E(R,C){const k=e.update(v);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Zi(r.x,r.y)),h.uniforms.shadow_pass.value=R.map.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,n.setRenderTarget(R.mapPass),n.clear(),n.renderBufferDirect(C,null,k,h,v,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,n.setRenderTarget(R.map),n.clear(),n.renderBufferDirect(C,null,k,p,v,null)}function A(R,C,k,y){let S=null;const O=k.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(O!==void 0)S=O;else if(S=k.isPointLight===!0?l:a,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const K=S.uuid,W=C.uuid;let z=c[K];z===void 0&&(z={},c[K]=z);let oe=z[W];oe===void 0&&(oe=S.clone(),z[W]=oe,C.addEventListener("dispose",I)),S=oe}if(S.visible=C.visible,S.wireframe=C.wireframe,y===Xn?S.side=C.shadowSide!==null?C.shadowSide:C.side:S.side=C.shadowSide!==null?C.shadowSide:f[C.side],S.alphaMap=C.alphaMap,S.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,S.map=C.map,S.clipShadows=C.clipShadows,S.clippingPlanes=C.clippingPlanes,S.clipIntersection=C.clipIntersection,S.displacementMap=C.displacementMap,S.displacementScale=C.displacementScale,S.displacementBias=C.displacementBias,S.wireframeLinewidth=C.wireframeLinewidth,S.linewidth=C.linewidth,k.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const K=n.properties.get(S);K.light=k}return S}function w(R,C,k,y,S){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&S===Xn)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,R.matrixWorld);const W=e.update(R),z=R.material;if(Array.isArray(z)){const oe=W.groups;for(let H=0,se=oe.length;H<se;H++){const X=oe[H],fe=z[X.materialIndex];if(fe&&fe.visible){const me=A(R,fe,y,S);R.onBeforeShadow(n,R,C,k,W,me,X),n.renderBufferDirect(k,null,W,me,R,X),R.onAfterShadow(n,R,C,k,W,me,X)}}}else if(z.visible){const oe=A(R,z,y,S);R.onBeforeShadow(n,R,C,k,W,oe,null),n.renderBufferDirect(k,null,W,oe,R,null),R.onAfterShadow(n,R,C,k,W,oe,null)}}const K=R.children;for(let W=0,z=K.length;W<z;W++)w(K[W],C,k,y,S)}function I(R){R.target.removeEventListener("dispose",I);for(const k in c){const y=c[k],S=R.target.uuid;S in y&&(y[S].dispose(),delete y[S])}}}const Ab={[ja]:Ya,[Ka]:Qa,[Za]:el,[Ir]:Ja,[Ya]:ja,[Qa]:Ka,[el]:Za,[Ja]:Ir};function wb(n,e){function t(){let F=!1;const ye=new Tt;let Se=null;const be=new Tt(0,0,0,0);return{setMask:function(de){Se!==de&&!F&&(n.colorMask(de,de,de,de),Se=de)},setLocked:function(de){F=de},setClear:function(de,ce,De,Xe,mt){mt===!0&&(de*=Xe,ce*=Xe,De*=Xe),ye.set(de,ce,De,Xe),be.equals(ye)===!1&&(n.clearColor(de,ce,De,Xe),be.copy(ye))},reset:function(){F=!1,Se=null,be.set(-1,0,0,0)}}}function i(){let F=!1,ye=!1,Se=null,be=null,de=null;return{setReversed:function(ce){if(ye!==ce){const De=e.get("EXT_clip_control");ce?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT),ye=ce;const Xe=de;de=null,this.setClear(Xe)}},getReversed:function(){return ye},setTest:function(ce){ce?P(n.DEPTH_TEST):he(n.DEPTH_TEST)},setMask:function(ce){Se!==ce&&!F&&(n.depthMask(ce),Se=ce)},setFunc:function(ce){if(ye&&(ce=Ab[ce]),be!==ce){switch(ce){case ja:n.depthFunc(n.NEVER);break;case Ya:n.depthFunc(n.ALWAYS);break;case Ka:n.depthFunc(n.LESS);break;case Ir:n.depthFunc(n.LEQUAL);break;case Za:n.depthFunc(n.EQUAL);break;case Ja:n.depthFunc(n.GEQUAL);break;case Qa:n.depthFunc(n.GREATER);break;case el:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}be=ce}},setLocked:function(ce){F=ce},setClear:function(ce){de!==ce&&(ye&&(ce=1-ce),n.clearDepth(ce),de=ce)},reset:function(){F=!1,Se=null,be=null,de=null,ye=!1}}}function r(){let F=!1,ye=null,Se=null,be=null,de=null,ce=null,De=null,Xe=null,mt=null;return{setTest:function(lt){F||(lt?P(n.STENCIL_TEST):he(n.STENCIL_TEST))},setMask:function(lt){ye!==lt&&!F&&(n.stencilMask(lt),ye=lt)},setFunc:function(lt,An,mn){(Se!==lt||be!==An||de!==mn)&&(n.stencilFunc(lt,An,mn),Se=lt,be=An,de=mn)},setOp:function(lt,An,mn){(ce!==lt||De!==An||Xe!==mn)&&(n.stencilOp(lt,An,mn),ce=lt,De=An,Xe=mn)},setLocked:function(lt){F=lt},setClear:function(lt){mt!==lt&&(n.clearStencil(lt),mt=lt)},reset:function(){F=!1,ye=null,Se=null,be=null,de=null,ce=null,De=null,Xe=null,mt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},f={},h=new WeakMap,p=[],g=null,v=!1,m=null,d=null,E=null,A=null,w=null,I=null,R=null,C=new ot(0,0,0),k=0,y=!1,S=null,O=null,K=null,W=null,z=null;const oe=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,se=0;const X=n.getParameter(n.VERSION);X.indexOf("WebGL")!==-1?(se=parseFloat(/^WebGL (\d)/.exec(X)[1]),H=se>=1):X.indexOf("OpenGL ES")!==-1&&(se=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),H=se>=2);let fe=null,me={};const Ce=n.getParameter(n.SCISSOR_BOX),ke=n.getParameter(n.VIEWPORT),Ye=new Tt().fromArray(Ce),tt=new Tt().fromArray(ke);function Qe(F,ye,Se,be){const de=new Uint8Array(4),ce=n.createTexture();n.bindTexture(F,ce),n.texParameteri(F,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(F,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let De=0;De<Se;De++)F===n.TEXTURE_3D||F===n.TEXTURE_2D_ARRAY?n.texImage3D(ye,0,n.RGBA,1,1,be,0,n.RGBA,n.UNSIGNED_BYTE,de):n.texImage2D(ye+De,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,de);return ce}const U={};U[n.TEXTURE_2D]=Qe(n.TEXTURE_2D,n.TEXTURE_2D,1),U[n.TEXTURE_CUBE_MAP]=Qe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),U[n.TEXTURE_2D_ARRAY]=Qe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),U[n.TEXTURE_3D]=Qe(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),P(n.DEPTH_TEST),o.setFunc(Ir),Y(!1),q(iu),P(n.CULL_FACE),D(ei);function P(F){u[F]!==!0&&(n.enable(F),u[F]=!0)}function he(F){u[F]!==!1&&(n.disable(F),u[F]=!1)}function Te(F,ye){return f[F]!==ye?(n.bindFramebuffer(F,ye),f[F]=ye,F===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=ye),F===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=ye),!0):!1}function L(F,ye){let Se=p,be=!1;if(F){Se=h.get(ye),Se===void 0&&(Se=[],h.set(ye,Se));const de=F.textures;if(Se.length!==de.length||Se[0]!==n.COLOR_ATTACHMENT0){for(let ce=0,De=de.length;ce<De;ce++)Se[ce]=n.COLOR_ATTACHMENT0+ce;Se.length=de.length,be=!0}}else Se[0]!==n.BACK&&(Se[0]=n.BACK,be=!0);be&&n.drawBuffers(Se)}function ae(F){return g!==F?(n.useProgram(F),g=F,!0):!1}const Ue={[Wi]:n.FUNC_ADD,[h0]:n.FUNC_SUBTRACT,[p0]:n.FUNC_REVERSE_SUBTRACT};Ue[m0]=n.MIN,Ue[x0]=n.MAX;const T={[g0]:n.ZERO,[_0]:n.ONE,[v0]:n.SRC_COLOR,[qa]:n.SRC_ALPHA,[T0]:n.SRC_ALPHA_SATURATE,[y0]:n.DST_COLOR,[b0]:n.DST_ALPHA,[S0]:n.ONE_MINUS_SRC_COLOR,[$a]:n.ONE_MINUS_SRC_ALPHA,[E0]:n.ONE_MINUS_DST_COLOR,[M0]:n.ONE_MINUS_DST_ALPHA,[A0]:n.CONSTANT_COLOR,[w0]:n.ONE_MINUS_CONSTANT_COLOR,[C0]:n.CONSTANT_ALPHA,[R0]:n.ONE_MINUS_CONSTANT_ALPHA};function D(F,ye,Se,be,de,ce,De,Xe,mt,lt){if(F===ei){v===!0&&(he(n.BLEND),v=!1);return}if(v===!1&&(P(n.BLEND),v=!0),F!==d0){if(F!==m||lt!==y){if((d!==Wi||w!==Wi)&&(n.blendEquation(n.FUNC_ADD),d=Wi,w=Wi),lt)switch(F){case Ar:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ru:n.blendFunc(n.ONE,n.ONE);break;case su:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ou:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Et("WebGLState: Invalid blending: ",F);break}else switch(F){case Ar:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ru:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case su:Et("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ou:Et("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Et("WebGLState: Invalid blending: ",F);break}E=null,A=null,I=null,R=null,C.set(0,0,0),k=0,m=F,y=lt}return}de=de||ye,ce=ce||Se,De=De||be,(ye!==d||de!==w)&&(n.blendEquationSeparate(Ue[ye],Ue[de]),d=ye,w=de),(Se!==E||be!==A||ce!==I||De!==R)&&(n.blendFuncSeparate(T[Se],T[be],T[ce],T[De]),E=Se,A=be,I=ce,R=De),(Xe.equals(C)===!1||mt!==k)&&(n.blendColor(Xe.r,Xe.g,Xe.b,mt),C.copy(Xe),k=mt),m=F,y=!1}function _(F,ye){F.side===Yn?he(n.CULL_FACE):P(n.CULL_FACE);let Se=F.side===kt;ye&&(Se=!Se),Y(Se),F.blending===Ar&&F.transparent===!1?D(ei):D(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),o.setFunc(F.depthFunc),o.setTest(F.depthTest),o.setMask(F.depthWrite),s.setMask(F.colorWrite);const be=F.stencilWrite;a.setTest(be),be&&(a.setMask(F.stencilWriteMask),a.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),a.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),J(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?P(n.SAMPLE_ALPHA_TO_COVERAGE):he(n.SAMPLE_ALPHA_TO_COVERAGE)}function Y(F){S!==F&&(F?n.frontFace(n.CW):n.frontFace(n.CCW),S=F)}function q(F){F!==c0?(P(n.CULL_FACE),F!==O&&(F===iu?n.cullFace(n.BACK):F===u0?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):he(n.CULL_FACE),O=F}function ne(F){F!==K&&(H&&n.lineWidth(F),K=F)}function J(F,ye,Se){F?(P(n.POLYGON_OFFSET_FILL),(W!==ye||z!==Se)&&(n.polygonOffset(ye,Se),W=ye,z=Se)):he(n.POLYGON_OFFSET_FILL)}function ue(F){F?P(n.SCISSOR_TEST):he(n.SCISSOR_TEST)}function ie(F){F===void 0&&(F=n.TEXTURE0+oe-1),fe!==F&&(n.activeTexture(F),fe=F)}function Z(F,ye,Se){Se===void 0&&(fe===null?Se=n.TEXTURE0+oe-1:Se=fe);let be=me[Se];be===void 0&&(be={type:void 0,texture:void 0},me[Se]=be),(be.type!==F||be.texture!==ye)&&(fe!==Se&&(n.activeTexture(Se),fe=Se),n.bindTexture(F,ye||U[F]),be.type=F,be.texture=ye)}function M(){const F=me[fe];F!==void 0&&F.type!==void 0&&(n.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function x(){try{n.compressedTexImage2D(...arguments)}catch(F){F("WebGLState:",F)}}function N(){try{n.compressedTexImage3D(...arguments)}catch(F){F("WebGLState:",F)}}function $(){try{n.texSubImage2D(...arguments)}catch(F){F("WebGLState:",F)}}function re(){try{n.texSubImage3D(...arguments)}catch(F){F("WebGLState:",F)}}function j(){try{n.compressedTexSubImage2D(...arguments)}catch(F){F("WebGLState:",F)}}function ge(){try{n.compressedTexSubImage3D(...arguments)}catch(F){F("WebGLState:",F)}}function pe(){try{n.texStorage2D(...arguments)}catch(F){F("WebGLState:",F)}}function we(){try{n.texStorage3D(...arguments)}catch(F){F("WebGLState:",F)}}function Ae(){try{n.texImage2D(...arguments)}catch(F){F("WebGLState:",F)}}function le(){try{n.texImage3D(...arguments)}catch(F){F("WebGLState:",F)}}function xe(F){Ye.equals(F)===!1&&(n.scissor(F.x,F.y,F.z,F.w),Ye.copy(F))}function Oe(F){tt.equals(F)===!1&&(n.viewport(F.x,F.y,F.z,F.w),tt.copy(F))}function Pe(F,ye){let Se=c.get(ye);Se===void 0&&(Se=new WeakMap,c.set(ye,Se));let be=Se.get(F);be===void 0&&(be=n.getUniformBlockIndex(ye,F.name),Se.set(F,be))}function ve(F,ye){const be=c.get(ye).get(F);l.get(ye)!==be&&(n.uniformBlockBinding(ye,be,F.__bindingPointIndex),l.set(ye,be))}function He(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},fe=null,me={},f={},h=new WeakMap,p=[],g=null,v=!1,m=null,d=null,E=null,A=null,w=null,I=null,R=null,C=new ot(0,0,0),k=0,y=!1,S=null,O=null,K=null,W=null,z=null,Ye.set(0,0,n.canvas.width,n.canvas.height),tt.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:P,disable:he,bindFramebuffer:Te,drawBuffers:L,useProgram:ae,setBlending:D,setMaterial:_,setFlipSided:Y,setCullFace:q,setLineWidth:ne,setPolygonOffset:J,setScissorTest:ue,activeTexture:ie,bindTexture:Z,unbindTexture:M,compressedTexImage2D:x,compressedTexImage3D:N,texImage2D:Ae,texImage3D:le,updateUBOMapping:Pe,uniformBlockBinding:ve,texStorage2D:pe,texStorage3D:we,texSubImage2D:$,texSubImage3D:re,compressedTexSubImage2D:j,compressedTexSubImage3D:ge,scissor:xe,viewport:Oe,reset:He}}function Cb(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new at,u=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(M,x){return p?new OffscreenCanvas(M,x):Ms("canvas")}function v(M,x,N){let $=1;const re=Z(M);if((re.width>N||re.height>N)&&($=N/Math.max(re.width,re.height)),$<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const j=Math.floor($*re.width),ge=Math.floor($*re.height);f===void 0&&(f=g(j,ge));const pe=x?g(j,ge):f;return pe.width=j,pe.height=ge,pe.getContext("2d").drawImage(M,0,0,j,ge),qe("WebGLRenderer: Texture has been resized from ("+re.width+"x"+re.height+") to ("+j+"x"+ge+")."),pe}else return"data"in M&&qe("WebGLRenderer: Image in DataTexture is too big ("+re.width+"x"+re.height+")."),M;return M}function m(M){return M.generateMipmaps}function d(M){n.generateMipmap(M)}function E(M){return M.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?n.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function A(M,x,N,$,re=!1){if(M!==null){if(n[M]!==void 0)return n[M];qe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let j=x;if(x===n.RED&&(N===n.FLOAT&&(j=n.R32F),N===n.HALF_FLOAT&&(j=n.R16F),N===n.UNSIGNED_BYTE&&(j=n.R8)),x===n.RED_INTEGER&&(N===n.UNSIGNED_BYTE&&(j=n.R8UI),N===n.UNSIGNED_SHORT&&(j=n.R16UI),N===n.UNSIGNED_INT&&(j=n.R32UI),N===n.BYTE&&(j=n.R8I),N===n.SHORT&&(j=n.R16I),N===n.INT&&(j=n.R32I)),x===n.RG&&(N===n.FLOAT&&(j=n.RG32F),N===n.HALF_FLOAT&&(j=n.RG16F),N===n.UNSIGNED_BYTE&&(j=n.RG8)),x===n.RG_INTEGER&&(N===n.UNSIGNED_BYTE&&(j=n.RG8UI),N===n.UNSIGNED_SHORT&&(j=n.RG16UI),N===n.UNSIGNED_INT&&(j=n.RG32UI),N===n.BYTE&&(j=n.RG8I),N===n.SHORT&&(j=n.RG16I),N===n.INT&&(j=n.RG32I)),x===n.RGB_INTEGER&&(N===n.UNSIGNED_BYTE&&(j=n.RGB8UI),N===n.UNSIGNED_SHORT&&(j=n.RGB16UI),N===n.UNSIGNED_INT&&(j=n.RGB32UI),N===n.BYTE&&(j=n.RGB8I),N===n.SHORT&&(j=n.RGB16I),N===n.INT&&(j=n.RGB32I)),x===n.RGBA_INTEGER&&(N===n.UNSIGNED_BYTE&&(j=n.RGBA8UI),N===n.UNSIGNED_SHORT&&(j=n.RGBA16UI),N===n.UNSIGNED_INT&&(j=n.RGBA32UI),N===n.BYTE&&(j=n.RGBA8I),N===n.SHORT&&(j=n.RGBA16I),N===n.INT&&(j=n.RGBA32I)),x===n.RGB&&(N===n.UNSIGNED_INT_5_9_9_9_REV&&(j=n.RGB9_E5),N===n.UNSIGNED_INT_10F_11F_11F_REV&&(j=n.R11F_G11F_B10F)),x===n.RGBA){const ge=re?yo:rt.getTransfer($);N===n.FLOAT&&(j=n.RGBA32F),N===n.HALF_FLOAT&&(j=n.RGBA16F),N===n.UNSIGNED_BYTE&&(j=ge===ut?n.SRGB8_ALPHA8:n.RGBA8),N===n.UNSIGNED_SHORT_4_4_4_4&&(j=n.RGBA4),N===n.UNSIGNED_SHORT_5_5_5_1&&(j=n.RGB5_A1)}return(j===n.R16F||j===n.R32F||j===n.RG16F||j===n.RG32F||j===n.RGBA16F||j===n.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function w(M,x){let N;return M?x===null||x===Ki||x===vs?N=n.DEPTH24_STENCIL8:x===Zn?N=n.DEPTH32F_STENCIL8:x===_s&&(N=n.DEPTH24_STENCIL8,qe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Ki||x===vs?N=n.DEPTH_COMPONENT24:x===Zn?N=n.DEPTH_COMPONENT32F:x===_s&&(N=n.DEPTH_COMPONENT16),N}function I(M,x){return m(M)===!0||M.isFramebufferTexture&&M.minFilter!==on&&M.minFilter!==hn?Math.log2(Math.max(x.width,x.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?x.mipmaps.length:1}function R(M){const x=M.target;x.removeEventListener("dispose",R),k(x),x.isVideoTexture&&u.delete(x)}function C(M){const x=M.target;x.removeEventListener("dispose",C),S(x)}function k(M){const x=i.get(M);if(x.__webglInit===void 0)return;const N=M.source,$=h.get(N);if($){const re=$[x.__cacheKey];re.usedTimes--,re.usedTimes===0&&y(M),Object.keys($).length===0&&h.delete(N)}i.remove(M)}function y(M){const x=i.get(M);n.deleteTexture(x.__webglTexture);const N=M.source,$=h.get(N);delete $[x.__cacheKey],o.memory.textures--}function S(M){const x=i.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),i.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(x.__webglFramebuffer[$]))for(let re=0;re<x.__webglFramebuffer[$].length;re++)n.deleteFramebuffer(x.__webglFramebuffer[$][re]);else n.deleteFramebuffer(x.__webglFramebuffer[$]);x.__webglDepthbuffer&&n.deleteRenderbuffer(x.__webglDepthbuffer[$])}else{if(Array.isArray(x.__webglFramebuffer))for(let $=0;$<x.__webglFramebuffer.length;$++)n.deleteFramebuffer(x.__webglFramebuffer[$]);else n.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&n.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&n.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let $=0;$<x.__webglColorRenderbuffer.length;$++)x.__webglColorRenderbuffer[$]&&n.deleteRenderbuffer(x.__webglColorRenderbuffer[$]);x.__webglDepthRenderbuffer&&n.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const N=M.textures;for(let $=0,re=N.length;$<re;$++){const j=i.get(N[$]);j.__webglTexture&&(n.deleteTexture(j.__webglTexture),o.memory.textures--),i.remove(N[$])}i.remove(M)}let O=0;function K(){O=0}function W(){const M=O;return M>=r.maxTextures&&qe("WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),O+=1,M}function z(M){const x=[];return x.push(M.wrapS),x.push(M.wrapT),x.push(M.wrapR||0),x.push(M.magFilter),x.push(M.minFilter),x.push(M.anisotropy),x.push(M.internalFormat),x.push(M.format),x.push(M.type),x.push(M.generateMipmaps),x.push(M.premultiplyAlpha),x.push(M.flipY),x.push(M.unpackAlignment),x.push(M.colorSpace),x.join()}function oe(M,x){const N=i.get(M);if(M.isVideoTexture&&ue(M),M.isRenderTargetTexture===!1&&M.isExternalTexture!==!0&&M.version>0&&N.__version!==M.version){const $=M.image;if($===null)qe("WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)qe("WebGLRenderer: Texture marked for update but image is incomplete");else{U(N,M,x);return}}else M.isExternalTexture&&(N.__webglTexture=M.sourceTexture?M.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,N.__webglTexture,n.TEXTURE0+x)}function H(M,x){const N=i.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&N.__version!==M.version){U(N,M,x);return}else M.isExternalTexture&&(N.__webglTexture=M.sourceTexture?M.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,N.__webglTexture,n.TEXTURE0+x)}function se(M,x){const N=i.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&N.__version!==M.version){U(N,M,x);return}t.bindTexture(n.TEXTURE_3D,N.__webglTexture,n.TEXTURE0+x)}function X(M,x){const N=i.get(M);if(M.version>0&&N.__version!==M.version){P(N,M,x);return}t.bindTexture(n.TEXTURE_CUBE_MAP,N.__webglTexture,n.TEXTURE0+x)}const fe={[il]:n.REPEAT,[Kn]:n.CLAMP_TO_EDGE,[rl]:n.MIRRORED_REPEAT},me={[on]:n.NEAREST,[z0]:n.NEAREST_MIPMAP_NEAREST,[Bs]:n.NEAREST_MIPMAP_LINEAR,[hn]:n.LINEAR,[ra]:n.LINEAR_MIPMAP_NEAREST,[qi]:n.LINEAR_MIPMAP_LINEAR},Ce={[W0]:n.NEVER,[K0]:n.ALWAYS,[X0]:n.LESS,[Md]:n.LEQUAL,[q0]:n.EQUAL,[Y0]:n.GEQUAL,[$0]:n.GREATER,[j0]:n.NOTEQUAL};function ke(M,x){if(x.type===Zn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===hn||x.magFilter===ra||x.magFilter===Bs||x.magFilter===qi||x.minFilter===hn||x.minFilter===ra||x.minFilter===Bs||x.minFilter===qi)&&qe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(M,n.TEXTURE_WRAP_S,fe[x.wrapS]),n.texParameteri(M,n.TEXTURE_WRAP_T,fe[x.wrapT]),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,fe[x.wrapR]),n.texParameteri(M,n.TEXTURE_MAG_FILTER,me[x.magFilter]),n.texParameteri(M,n.TEXTURE_MIN_FILTER,me[x.minFilter]),x.compareFunction&&(n.texParameteri(M,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(M,n.TEXTURE_COMPARE_FUNC,Ce[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===on||x.minFilter!==Bs&&x.minFilter!==qi||x.type===Zn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");n.texParameterf(M,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function Ye(M,x){let N=!1;M.__webglInit===void 0&&(M.__webglInit=!0,x.addEventListener("dispose",R));const $=x.source;let re=h.get($);re===void 0&&(re={},h.set($,re));const j=z(x);if(j!==M.__cacheKey){re[j]===void 0&&(re[j]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,N=!0),re[j].usedTimes++;const ge=re[M.__cacheKey];ge!==void 0&&(re[M.__cacheKey].usedTimes--,ge.usedTimes===0&&y(x)),M.__cacheKey=j,M.__webglTexture=re[j].texture}return N}function tt(M,x,N){return Math.floor(Math.floor(M/N)/x)}function Qe(M,x,N,$){const j=M.updateRanges;if(j.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,x.width,x.height,N,$,x.data);else{j.sort((le,xe)=>le.start-xe.start);let ge=0;for(let le=1;le<j.length;le++){const xe=j[ge],Oe=j[le],Pe=xe.start+xe.count,ve=tt(Oe.start,x.width,4),He=tt(xe.start,x.width,4);Oe.start<=Pe+1&&ve===He&&tt(Oe.start+Oe.count-1,x.width,4)===ve?xe.count=Math.max(xe.count,Oe.start+Oe.count-xe.start):(++ge,j[ge]=Oe)}j.length=ge+1;const pe=n.getParameter(n.UNPACK_ROW_LENGTH),we=n.getParameter(n.UNPACK_SKIP_PIXELS),Ae=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,x.width);for(let le=0,xe=j.length;le<xe;le++){const Oe=j[le],Pe=Math.floor(Oe.start/4),ve=Math.ceil(Oe.count/4),He=Pe%x.width,F=Math.floor(Pe/x.width),ye=ve,Se=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,He),n.pixelStorei(n.UNPACK_SKIP_ROWS,F),t.texSubImage2D(n.TEXTURE_2D,0,He,F,ye,Se,N,$,x.data)}M.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,pe),n.pixelStorei(n.UNPACK_SKIP_PIXELS,we),n.pixelStorei(n.UNPACK_SKIP_ROWS,Ae)}}function U(M,x,N){let $=n.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&($=n.TEXTURE_2D_ARRAY),x.isData3DTexture&&($=n.TEXTURE_3D);const re=Ye(M,x),j=x.source;t.bindTexture($,M.__webglTexture,n.TEXTURE0+N);const ge=i.get(j);if(j.version!==ge.__version||re===!0){t.activeTexture(n.TEXTURE0+N);const pe=rt.getPrimaries(rt.workingColorSpace),we=x.colorSpace===Mi?null:rt.getPrimaries(x.colorSpace),Ae=x.colorSpace===Mi||pe===we?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);let le=v(x.image,!1,r.maxTextureSize);le=ie(x,le);const xe=s.convert(x.format,x.colorSpace),Oe=s.convert(x.type);let Pe=A(x.internalFormat,xe,Oe,x.colorSpace,x.isVideoTexture);ke($,x);let ve;const He=x.mipmaps,F=x.isVideoTexture!==!0,ye=ge.__version===void 0||re===!0,Se=j.dataReady,be=I(x,le);if(x.isDepthTexture)Pe=w(x.format===bs,x.type),ye&&(F?t.texStorage2D(n.TEXTURE_2D,1,Pe,le.width,le.height):t.texImage2D(n.TEXTURE_2D,0,Pe,le.width,le.height,0,xe,Oe,null));else if(x.isDataTexture)if(He.length>0){F&&ye&&t.texStorage2D(n.TEXTURE_2D,be,Pe,He[0].width,He[0].height);for(let de=0,ce=He.length;de<ce;de++)ve=He[de],F?Se&&t.texSubImage2D(n.TEXTURE_2D,de,0,0,ve.width,ve.height,xe,Oe,ve.data):t.texImage2D(n.TEXTURE_2D,de,Pe,ve.width,ve.height,0,xe,Oe,ve.data);x.generateMipmaps=!1}else F?(ye&&t.texStorage2D(n.TEXTURE_2D,be,Pe,le.width,le.height),Se&&Qe(x,le,xe,Oe)):t.texImage2D(n.TEXTURE_2D,0,Pe,le.width,le.height,0,xe,Oe,le.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){F&&ye&&t.texStorage3D(n.TEXTURE_2D_ARRAY,be,Pe,He[0].width,He[0].height,le.depth);for(let de=0,ce=He.length;de<ce;de++)if(ve=He[de],x.format!==bn)if(xe!==null)if(F){if(Se)if(x.layerUpdates.size>0){const De=Du(ve.width,ve.height,x.format,x.type);for(const Xe of x.layerUpdates){const mt=ve.data.subarray(Xe*De/ve.data.BYTES_PER_ELEMENT,(Xe+1)*De/ve.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,de,0,0,Xe,ve.width,ve.height,1,xe,mt)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,de,0,0,0,ve.width,ve.height,le.depth,xe,ve.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,de,Pe,ve.width,ve.height,le.depth,0,ve.data,0,0);else qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else F?Se&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,de,0,0,0,ve.width,ve.height,le.depth,xe,Oe,ve.data):t.texImage3D(n.TEXTURE_2D_ARRAY,de,Pe,ve.width,ve.height,le.depth,0,xe,Oe,ve.data)}else{F&&ye&&t.texStorage2D(n.TEXTURE_2D,be,Pe,He[0].width,He[0].height);for(let de=0,ce=He.length;de<ce;de++)ve=He[de],x.format!==bn?xe!==null?F?Se&&t.compressedTexSubImage2D(n.TEXTURE_2D,de,0,0,ve.width,ve.height,xe,ve.data):t.compressedTexImage2D(n.TEXTURE_2D,de,Pe,ve.width,ve.height,0,ve.data):qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):F?Se&&t.texSubImage2D(n.TEXTURE_2D,de,0,0,ve.width,ve.height,xe,Oe,ve.data):t.texImage2D(n.TEXTURE_2D,de,Pe,ve.width,ve.height,0,xe,Oe,ve.data)}else if(x.isDataArrayTexture)if(F){if(ye&&t.texStorage3D(n.TEXTURE_2D_ARRAY,be,Pe,le.width,le.height,le.depth),Se)if(x.layerUpdates.size>0){const de=Du(le.width,le.height,x.format,x.type);for(const ce of x.layerUpdates){const De=le.data.subarray(ce*de/le.data.BYTES_PER_ELEMENT,(ce+1)*de/le.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ce,le.width,le.height,1,xe,Oe,De)}x.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,le.width,le.height,le.depth,xe,Oe,le.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Pe,le.width,le.height,le.depth,0,xe,Oe,le.data);else if(x.isData3DTexture)F?(ye&&t.texStorage3D(n.TEXTURE_3D,be,Pe,le.width,le.height,le.depth),Se&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,le.width,le.height,le.depth,xe,Oe,le.data)):t.texImage3D(n.TEXTURE_3D,0,Pe,le.width,le.height,le.depth,0,xe,Oe,le.data);else if(x.isFramebufferTexture){if(ye)if(F)t.texStorage2D(n.TEXTURE_2D,be,Pe,le.width,le.height);else{let de=le.width,ce=le.height;for(let De=0;De<be;De++)t.texImage2D(n.TEXTURE_2D,De,Pe,de,ce,0,xe,Oe,null),de>>=1,ce>>=1}}else if(He.length>0){if(F&&ye){const de=Z(He[0]);t.texStorage2D(n.TEXTURE_2D,be,Pe,de.width,de.height)}for(let de=0,ce=He.length;de<ce;de++)ve=He[de],F?Se&&t.texSubImage2D(n.TEXTURE_2D,de,0,0,xe,Oe,ve):t.texImage2D(n.TEXTURE_2D,de,Pe,xe,Oe,ve);x.generateMipmaps=!1}else if(F){if(ye){const de=Z(le);t.texStorage2D(n.TEXTURE_2D,be,Pe,de.width,de.height)}Se&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,xe,Oe,le)}else t.texImage2D(n.TEXTURE_2D,0,Pe,xe,Oe,le);m(x)&&d($),ge.__version=j.version,x.onUpdate&&x.onUpdate(x)}M.__version=x.version}function P(M,x,N){if(x.image.length!==6)return;const $=Ye(M,x),re=x.source;t.bindTexture(n.TEXTURE_CUBE_MAP,M.__webglTexture,n.TEXTURE0+N);const j=i.get(re);if(re.version!==j.__version||$===!0){t.activeTexture(n.TEXTURE0+N);const ge=rt.getPrimaries(rt.workingColorSpace),pe=x.colorSpace===Mi?null:rt.getPrimaries(x.colorSpace),we=x.colorSpace===Mi||ge===pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);const Ae=x.isCompressedTexture||x.image[0].isCompressedTexture,le=x.image[0]&&x.image[0].isDataTexture,xe=[];for(let ce=0;ce<6;ce++)!Ae&&!le?xe[ce]=v(x.image[ce],!0,r.maxCubemapSize):xe[ce]=le?x.image[ce].image:x.image[ce],xe[ce]=ie(x,xe[ce]);const Oe=xe[0],Pe=s.convert(x.format,x.colorSpace),ve=s.convert(x.type),He=A(x.internalFormat,Pe,ve,x.colorSpace),F=x.isVideoTexture!==!0,ye=j.__version===void 0||$===!0,Se=re.dataReady;let be=I(x,Oe);ke(n.TEXTURE_CUBE_MAP,x);let de;if(Ae){F&&ye&&t.texStorage2D(n.TEXTURE_CUBE_MAP,be,He,Oe.width,Oe.height);for(let ce=0;ce<6;ce++){de=xe[ce].mipmaps;for(let De=0;De<de.length;De++){const Xe=de[De];x.format!==bn?Pe!==null?F?Se&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,De,0,0,Xe.width,Xe.height,Pe,Xe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,De,He,Xe.width,Xe.height,0,Xe.data):qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):F?Se&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,De,0,0,Xe.width,Xe.height,Pe,ve,Xe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,De,He,Xe.width,Xe.height,0,Pe,ve,Xe.data)}}}else{if(de=x.mipmaps,F&&ye){de.length>0&&be++;const ce=Z(xe[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,be,He,ce.width,ce.height)}for(let ce=0;ce<6;ce++)if(le){F?Se&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,xe[ce].width,xe[ce].height,Pe,ve,xe[ce].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,He,xe[ce].width,xe[ce].height,0,Pe,ve,xe[ce].data);for(let De=0;De<de.length;De++){const mt=de[De].image[ce].image;F?Se&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,De+1,0,0,mt.width,mt.height,Pe,ve,mt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,De+1,He,mt.width,mt.height,0,Pe,ve,mt.data)}}else{F?Se&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,Pe,ve,xe[ce]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,He,Pe,ve,xe[ce]);for(let De=0;De<de.length;De++){const Xe=de[De];F?Se&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,De+1,0,0,Pe,ve,Xe.image[ce]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,De+1,He,Pe,ve,Xe.image[ce])}}}m(x)&&d(n.TEXTURE_CUBE_MAP),j.__version=re.version,x.onUpdate&&x.onUpdate(x)}M.__version=x.version}function he(M,x,N,$,re,j){const ge=s.convert(N.format,N.colorSpace),pe=s.convert(N.type),we=A(N.internalFormat,ge,pe,N.colorSpace),Ae=i.get(x),le=i.get(N);if(le.__renderTarget=x,!Ae.__hasExternalTextures){const xe=Math.max(1,x.width>>j),Oe=Math.max(1,x.height>>j);re===n.TEXTURE_3D||re===n.TEXTURE_2D_ARRAY?t.texImage3D(re,j,we,xe,Oe,x.depth,0,ge,pe,null):t.texImage2D(re,j,we,xe,Oe,0,ge,pe,null)}t.bindFramebuffer(n.FRAMEBUFFER,M),J(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,$,re,le.__webglTexture,0,ne(x)):(re===n.TEXTURE_2D||re>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&re<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,$,re,le.__webglTexture,j),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Te(M,x,N){if(n.bindRenderbuffer(n.RENDERBUFFER,M),x.depthBuffer){const $=x.depthTexture,re=$&&$.isDepthTexture?$.type:null,j=w(x.stencilBuffer,re),ge=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,pe=ne(x);J(x)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,pe,j,x.width,x.height):N?n.renderbufferStorageMultisample(n.RENDERBUFFER,pe,j,x.width,x.height):n.renderbufferStorage(n.RENDERBUFFER,j,x.width,x.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ge,n.RENDERBUFFER,M)}else{const $=x.textures;for(let re=0;re<$.length;re++){const j=$[re],ge=s.convert(j.format,j.colorSpace),pe=s.convert(j.type),we=A(j.internalFormat,ge,pe,j.colorSpace),Ae=ne(x);N&&J(x)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ae,we,x.width,x.height):J(x)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ae,we,x.width,x.height):n.renderbufferStorage(n.RENDERBUFFER,we,x.width,x.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function L(M,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,M),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=i.get(x.depthTexture);$.__renderTarget=x,(!$.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),oe(x.depthTexture,0);const re=$.__webglTexture,j=ne(x);if(x.depthTexture.format===Ss)J(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,re,0,j):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,re,0);else if(x.depthTexture.format===bs)J(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,re,0,j):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,re,0);else throw new Error("Unknown depthTexture format")}function ae(M){const x=i.get(M),N=M.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==M.depthTexture){const $=M.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),$){const re=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,$.removeEventListener("dispose",re)};$.addEventListener("dispose",re),x.__depthDisposeCallback=re}x.__boundDepthTexture=$}if(M.depthTexture&&!x.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");const $=M.texture.mipmaps;$&&$.length>0?L(x.__webglFramebuffer[0],M):L(x.__webglFramebuffer,M)}else if(N){x.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(t.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer[$]),x.__webglDepthbuffer[$]===void 0)x.__webglDepthbuffer[$]=n.createRenderbuffer(),Te(x.__webglDepthbuffer[$],M,!1);else{const re=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,j=x.__webglDepthbuffer[$];n.bindRenderbuffer(n.RENDERBUFFER,j),n.framebufferRenderbuffer(n.FRAMEBUFFER,re,n.RENDERBUFFER,j)}}else{const $=M.texture.mipmaps;if($&&$.length>0?t.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=n.createRenderbuffer(),Te(x.__webglDepthbuffer,M,!1);else{const re=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,j=x.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,j),n.framebufferRenderbuffer(n.FRAMEBUFFER,re,n.RENDERBUFFER,j)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ue(M,x,N){const $=i.get(M);x!==void 0&&he($.__webglFramebuffer,M,M.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),N!==void 0&&ae(M)}function T(M){const x=M.texture,N=i.get(M),$=i.get(x);M.addEventListener("dispose",C);const re=M.textures,j=M.isWebGLCubeRenderTarget===!0,ge=re.length>1;if(ge||($.__webglTexture===void 0&&($.__webglTexture=n.createTexture()),$.__version=x.version,o.memory.textures++),j){N.__webglFramebuffer=[];for(let pe=0;pe<6;pe++)if(x.mipmaps&&x.mipmaps.length>0){N.__webglFramebuffer[pe]=[];for(let we=0;we<x.mipmaps.length;we++)N.__webglFramebuffer[pe][we]=n.createFramebuffer()}else N.__webglFramebuffer[pe]=n.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){N.__webglFramebuffer=[];for(let pe=0;pe<x.mipmaps.length;pe++)N.__webglFramebuffer[pe]=n.createFramebuffer()}else N.__webglFramebuffer=n.createFramebuffer();if(ge)for(let pe=0,we=re.length;pe<we;pe++){const Ae=i.get(re[pe]);Ae.__webglTexture===void 0&&(Ae.__webglTexture=n.createTexture(),o.memory.textures++)}if(M.samples>0&&J(M)===!1){N.__webglMultisampledFramebuffer=n.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let pe=0;pe<re.length;pe++){const we=re[pe];N.__webglColorRenderbuffer[pe]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,N.__webglColorRenderbuffer[pe]);const Ae=s.convert(we.format,we.colorSpace),le=s.convert(we.type),xe=A(we.internalFormat,Ae,le,we.colorSpace,M.isXRRenderTarget===!0),Oe=ne(M);n.renderbufferStorageMultisample(n.RENDERBUFFER,Oe,xe,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,N.__webglColorRenderbuffer[pe])}n.bindRenderbuffer(n.RENDERBUFFER,null),M.depthBuffer&&(N.__webglDepthRenderbuffer=n.createRenderbuffer(),Te(N.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(j){t.bindTexture(n.TEXTURE_CUBE_MAP,$.__webglTexture),ke(n.TEXTURE_CUBE_MAP,x);for(let pe=0;pe<6;pe++)if(x.mipmaps&&x.mipmaps.length>0)for(let we=0;we<x.mipmaps.length;we++)he(N.__webglFramebuffer[pe][we],M,x,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we);else he(N.__webglFramebuffer[pe],M,x,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0);m(x)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ge){for(let pe=0,we=re.length;pe<we;pe++){const Ae=re[pe],le=i.get(Ae);let xe=n.TEXTURE_2D;(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(xe=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(xe,le.__webglTexture),ke(xe,Ae),he(N.__webglFramebuffer,M,Ae,n.COLOR_ATTACHMENT0+pe,xe,0),m(Ae)&&d(xe)}t.unbindTexture()}else{let pe=n.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(pe=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(pe,$.__webglTexture),ke(pe,x),x.mipmaps&&x.mipmaps.length>0)for(let we=0;we<x.mipmaps.length;we++)he(N.__webglFramebuffer[we],M,x,n.COLOR_ATTACHMENT0,pe,we);else he(N.__webglFramebuffer,M,x,n.COLOR_ATTACHMENT0,pe,0);m(x)&&d(pe),t.unbindTexture()}M.depthBuffer&&ae(M)}function D(M){const x=M.textures;for(let N=0,$=x.length;N<$;N++){const re=x[N];if(m(re)){const j=E(M),ge=i.get(re).__webglTexture;t.bindTexture(j,ge),d(j),t.unbindTexture()}}}const _=[],Y=[];function q(M){if(M.samples>0){if(J(M)===!1){const x=M.textures,N=M.width,$=M.height;let re=n.COLOR_BUFFER_BIT;const j=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ge=i.get(M),pe=x.length>1;if(pe)for(let Ae=0;Ae<x.length;Ae++)t.bindFramebuffer(n.FRAMEBUFFER,ge.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ae,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ge.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ae,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ge.__webglMultisampledFramebuffer);const we=M.texture.mipmaps;we&&we.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ge.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ge.__webglFramebuffer);for(let Ae=0;Ae<x.length;Ae++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(re|=n.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(re|=n.STENCIL_BUFFER_BIT)),pe){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ge.__webglColorRenderbuffer[Ae]);const le=i.get(x[Ae]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,le,0)}n.blitFramebuffer(0,0,N,$,0,0,N,$,re,n.NEAREST),l===!0&&(_.length=0,Y.length=0,_.push(n.COLOR_ATTACHMENT0+Ae),M.depthBuffer&&M.resolveDepthBuffer===!1&&(_.push(j),Y.push(j),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Y)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,_))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),pe)for(let Ae=0;Ae<x.length;Ae++){t.bindFramebuffer(n.FRAMEBUFFER,ge.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ae,n.RENDERBUFFER,ge.__webglColorRenderbuffer[Ae]);const le=i.get(x[Ae]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ge.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ae,n.TEXTURE_2D,le,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ge.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&l){const x=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[x])}}}function ne(M){return Math.min(r.maxSamples,M.samples)}function J(M){const x=i.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function ue(M){const x=o.render.frame;u.get(M)!==x&&(u.set(M,x),M.update())}function ie(M,x){const N=M.colorSpace,$=M.format,re=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||N!==Nr&&N!==Mi&&(rt.getTransfer(N)===ut?($!==bn||re!==si)&&qe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Et("WebGLTextures: Unsupported texture color space:",N)),x}function Z(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(c.width=M.naturalWidth||M.width,c.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(c.width=M.displayWidth,c.height=M.displayHeight):(c.width=M.width,c.height=M.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=K,this.setTexture2D=oe,this.setTexture2DArray=H,this.setTexture3D=se,this.setTextureCube=X,this.rebindTextures=Ue,this.setupRenderTarget=T,this.updateRenderTargetMipmap=D,this.updateMultisampleRenderTarget=q,this.setupDepthRenderbuffer=ae,this.setupFrameBufferTexture=he,this.useMultisampledRTT=J}function Rb(n,e){function t(i,r=Mi){let s;const o=rt.getTransfer(r);if(i===si)return n.UNSIGNED_BYTE;if(i===nc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===ic)return n.UNSIGNED_SHORT_5_5_5_1;if(i===gd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===_d)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===md)return n.BYTE;if(i===xd)return n.SHORT;if(i===_s)return n.UNSIGNED_SHORT;if(i===tc)return n.INT;if(i===Ki)return n.UNSIGNED_INT;if(i===Zn)return n.FLOAT;if(i===Br)return n.HALF_FLOAT;if(i===vd)return n.ALPHA;if(i===Sd)return n.RGB;if(i===bn)return n.RGBA;if(i===Ss)return n.DEPTH_COMPONENT;if(i===bs)return n.DEPTH_STENCIL;if(i===bd)return n.RED;if(i===rc)return n.RED_INTEGER;if(i===sc)return n.RG;if(i===oc)return n.RG_INTEGER;if(i===ac)return n.RGBA_INTEGER;if(i===uo||i===fo||i===ho||i===po)if(o===ut)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===uo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===fo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ho)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===po)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===uo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===fo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ho)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===po)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===sl||i===ol||i===al||i===ll)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===sl)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===ol)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===al)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===ll)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===cl||i===ul||i===fl)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===cl||i===ul)return o===ut?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===fl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===dl||i===hl||i===pl||i===ml||i===xl||i===gl||i===_l||i===vl||i===Sl||i===bl||i===Ml||i===yl||i===El||i===Tl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===dl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===hl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===pl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ml)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===xl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===gl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===_l)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===vl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Sl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===bl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Ml)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===yl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===El)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Tl)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Al||i===wl||i===Cl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Al)return o===ut?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===wl)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Cl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Rl||i===Pl||i===Dl||i===Il)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Rl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Pl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Dl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Il)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===vs?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const Pb=`
void main() {
            ...
            textureLoader.load(imageUrl, (texture) => {
                ...
                if (sceneData.hotspots) {
                    sceneData.hotspots.forEach((hotspot, i) => {
                        ...
                        const size = (hotspot.radius * 2 * 3) || 20; // Utiliser le radius du hotspot, défaut à 20px (x3)
                ...
                if (sceneData && sceneData.hotspots) {
                    ...
                    sceneData.hotspots.forEach((hotspot, i) => {
                        if (hotspots[i] && hotspots[i].element) {
                            ...
                            const baseSize = (hotspot.radius * 2 * 3) || 20;
