...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function Kc(){return new Hi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ol(),fragmentShader:`
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function Zc(){return new Hi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ol(),fragmentShader:`
...
initViewer()
    `}}function id(n){return nE.exportAsHTMLStandalone(n)}const iE={class:"export-panel"},rE={class:"export-container"},sE={class:"export-preview"},oE={class:"project-info"},aE={class:"info-row"},lE={class:"info-row"},cE={class:"info-row"},uE={class:"info-row"},fE=gi({__name:"ExportPanel",setup(n){const e=zi(),t=hi(()=>{var s;return((s=e.project)==null?void 0:s.scenes.reduce((a,o)=>a+o.hotspots.length,0))||0}),i=hi(()=>{if(!e.project)return"0 MB";const s=JSON.stringify(e.project);return(new Blob([s]).size/1024/1024).toFixed(2)+" MB"}),r=()=>{if(!e.project)return;const s=id(e.project),a=new Blob([s],{type:"text/html"}),o=URL.createObjectURL(a),l=document.createElement("a");l.href=o,l.download="index.html",l.click(),URL.revokeObjectURL(o)};return(s,a)=>{var o,l;return Ue(),De("div",iE,[O("div",rE,[a[8]||(a[8]=O("h2",null,"Exporter le Projet",-1)),O("div",sE,[a[4]||(a[4]=O("h3",null,"Apercu du Projet",-1)),O("div",oE,[O("div",aE,[a[0]||(a[0]=O("label",null,"Nom:",-1)),O("span",null,gt((o=Ye(e).project)==null?void 0:o.name),1)]),O("div",lE,[a[1]||(a[1]=O("label",null,"Scenes:",-1)),O("span",null,gt((l=Ye(e).project)==null?void 0:l.scenes.length),1)]),O("div",cE,[a[2]||(a[2]=O("label",null,"Hotspots:",-1)),O("span",null,gt(t.value),1)]),O("div",uE,[a[3]||(a[3]=O("label",null,"Taille approx:",-1)),O("span",null,gt(i.value),1)])])]),O("div",{class:"export-options"},[O("div",{class:"export-card"},[a[5]||(a[5]=O("div",{class:"card-icon"},"📄",-1)),a[6]||(a[6]=O("h3",null,"HTML Standalone",-1)),a[7]||(a[7]=O("p",null,"Génère un fichier index.html unique à lancer (de préférence avec Chrome pour assurer un maximum de compatibilité).",-1)),O("button",{onClick:r,class:"btn-export"},"Telecharger HTML")])])])])}}});const dE=_i(fE,[["__scopeId","data-v-825179a4"]]),hE={class:"export-viewer"},pE=["srcdoc"],mE=gi({__name:"ExportViewer",setup(n){const e=zi(),t=ze(null),i=hi(()=>e.project?id(e.project):"");return(r,s)=>(Ue(),De("div",hE,[O("iframe",{ref_key:"iframeRef",ref:t,srcdoc:i.value,title:"Export Preview"},null,8,pE)]))}});const gE=_i(mE,[["__scopeId","data-v-5051169c"]]),_E={class:"app-container"},vE={class:"toasts-container"},xE={key:1,class:"editor-layout"},SE={class:"sidebar"},ME={class:"main-content"},EE={class:"editor-tabs"},yE=gi({__name:"App",setup(n){const e=zi(),t=ze("editor"),i=(s,a)=>{e.createNewProject(s,a)},r=s=>{e.loadProject(s)};return mo(async()=>{console.log("App initialized - showing HomeScreen")}),(s,a)=>(Ue(),De("div",_E,[O("div",vE,[(Ue(!0),De(ut,null,Pi(Ye(no),o=>(Ue(),De("div",{key:o.id,class:qt(["toast",`toast-${o.type}`])},gt(o.message),3))),128))]),Ye(e).project?(Ue(),De("div",xE,[O("div",SE,[nn(sm),nn(Mm)]),O("div",ME,[O("div",EE,[O("button",{class:qt([{active:t.value==="editor"},"tab-btn"]),onClick:a[0]||(a[0]=o=>t.value="editor")}," ✏️ Éditeur ",2),O("button",{class:qt([{active:t.value==="export-viewer"},"tab-btn"]),onClick:a[1]||(a[1]=o=>t.value="export-viewer")}," 👀 Apercu ",2),O("button",{class:qt([{active:t.value==="export"},"tab-btn"]),onClick:a[2]||(a[2]=o=>t.value="export")}," 💾 Exporter ",2)]),t.value==="editor"?(Ue(),De(ut,{key:0},[Ye(e).activeScene?(Ue(),cr(tE,{key:0})):lt("",!0)],64)):t.value==="export"?(Ue(),cr(dE,{key:1})):t.value==="export-viewer"?(Ue(),De(ut,{key:2},[Ye(e).project?(Ue(),cr(gE,{key:0})):lt("",!0)],64)):lt("",!0)])])):(Ue(),cr(tm,{key:0,onCreateProject:i,onLoadProject:r}))]))}});const bE=_i(yE,[["__scopeId","data-v-bf1d6ca7"]]),rd=Fp(bE);rd.use(zp());rd.mount("#app");
