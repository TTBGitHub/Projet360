...
initViewer()
    `}}function rd(n){return iE.exportAsHTMLStandalone(n)}const rE={class:"export-panel"},sE={class:"export-container"},oE={class:"export-preview"},aE={class:"project-info"},lE={class:"info-row"},cE={class:"info-row"},uE={class:"info-row"},fE={class:"info-row"},dE=gi({__name:"ExportPanel",setup(n){const e=zi(),t=hi(()=>{var s;return((s=e.project)==null?void 0:s.scenes.reduce((a,o)=>a+o.hotspots.length,0))||0}),i=hi(()=>{if(!e.project)return"0 MB";const s=JSON.stringify(e.project);return(new Blob([s]).size/1024/1024).toFixed(2)+" MB"}),r=()=>{if(!e.project)return;const s=rd(e.project),a=new Blob([s],{type:"text/html"}),o=URL.createObjectURL(a),l=document.createElement("a");l.href=o,l.download="index.html",l.click(),URL.revokeObjectURL(o)};return(s,a)=>{var o,l;return Ue(),De("div",rE,[O("div",sE,[a[8]||(a[8]=O("h2",null,"Exporter le Projet",-1)),O("div",oE,[a[4]||(a[4]=O("h3",null,"Apercu du Projet",-1)),O("div",aE,[O("div",lE,[a[0]||(a[0]=O("label",null,"Nom:",-1)),O("span",null,_t((o=Ye(e).project)==null?void 0:o.name),1)]),O("div",cE,[a[1]||(a[1]=O("label",null,"Scenes:",-1)),O("span",null,_t((l=Ye(e).project)==null?void 0:l.scenes.length),1)]),O("div",uE,[a[2]||(a[2]=O("label",null,"Hotspots:",-1)),O("span",null,_t(t.value),1)]),O("div",fE,[a[3]||(a[3]=O("label",null,"Taille approx:",-1)),O("span",null,_t(i.value),1)])])]),O("div",{class:"export-options"},[O("div",{class:"export-card"},[a[5]||(a[5]=O("div",{class:"card-icon"},"📄",-1)),a[6]||(a[6]=O("h3",null,"HTML Standalone",-1)),a[7]||(a[7]=O("p",null,"Génère un fichier index.html unique à lancer (de préférence avec Chrome pour assurer un maximum de compatibilité).",-1)),O("button",{onClick:r,class:"btn-export"},"Telecharger HTML")])])])])}}});const hE=_i(dE,[["__scopeId","data-v-825179a4"]]),pE={class:"export-viewer"},mE=["srcdoc"],gE=gi({__name:"ExportViewer",setup(n){const e=zi(),t=ze(null),i=hi(()=>e.project?rd(e.project):"");return(r,s)=>(Ue(),De("div",pE,[O("iframe",{ref_key:"iframeRef",ref:t,srcdoc:i.value,title:"Export Preview"},null,8,mE)]))}});const _E=_i(gE,[["__scopeId","data-v-5051169c"]]),vE={class:"app-container"},xE={class:"toasts-container"},SE={key:1,class:"editor-layout"},ME={class:"sidebar"},EE={class:"main-content"},yE={class:"editor-tabs"},bE=gi({__name:"App",setup(n){const e=zi(),t=ze("editor"),i=(s,a)=>{e.createNewProject(s,a)},r=s=>{e.loadProject(s)};return mo(async()=>{console.log("App initialized - showing HomeScreen")}),(s,a)=>(Ue(),De("div",vE,[O("div",xE,[(Ue(!0),De(ut,null,Pi(Ye(no),o=>(Ue(),De("div",{key:o.id,class:qt(["toast",`toast-${o.type}`])},_t(o.message),3))),128))]),Ye(e).project?(Ue(),De("div",SE,[O("div",ME,[nn(sm),nn(Mm)]),O("div",EE,[O("div",yE,[O("button",{class:qt([{active:t.value==="editor"},"tab-btn"]),onClick:a[0]||(a[0]=o=>t.value="editor")}," ✏️ Éditeur ",2),O("button",{class:qt([{active:t.value==="export-viewer"},"tab-btn"]),onClick:a[1]||(a[1]=o=>t.value="export-viewer")}," 👀 Apercu ",2),O("button",{class:qt([{active:t.value==="export"},"tab-btn"]),onClick:a[2]||(a[2]=o=>t.value="export")}," 💾 Exporter ",2)]),t.value==="editor"?(Ue(),De(ut,{key:0},[Ye(e).activeScene?(Ue(),cr(nE,{key:0})):lt("",!0)],64)):t.value==="export"?(Ue(),cr(hE,{key:1})):t.value==="export-viewer"?(Ue(),De(ut,{key:2},[Ye(e).project?(Ue(),cr(_E,{key:0})):lt("",!0)],64)):lt("",!0)])])):(Ue(),cr(tm,{key:0,onCreateProject:i,onLoadProject:r}))]))}});const TE=_i(bE,[["__scopeId","data-v-bf1d6ca7"]]),sd=Fp(TE);sd.use(zp());sd.mount("#app");
